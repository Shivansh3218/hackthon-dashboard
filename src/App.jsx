  ...
  function getDetails(data) {
    ...
    axios({
      ...
      headers: {
        ...
        Authorization:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjQyMzc3IiwiZW1haWwiOiJzaGl2YW5zaEBuYXZndXJ1a3VsLm9yZyIsImlhdCI6MTY5NTk4MDAwNSwiZXhwIjoxNzI3NTM3NjA1fQ.SXVJp_sg2SSrFwTXS2putJIv8DPXMtMs6oc4FSCEFCI",
      },
    }).then((res) => {
          ...
          <TableBody>
            {data.map((data) => (
              ...
              >
                ...
                <TableCell align="right">
                <img src={data.profile_picture} alt={data.name} style={{width:"30px"}}/>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
